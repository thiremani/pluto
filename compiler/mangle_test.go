...
func TestMangle(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			relPath:  "",
			funcName: "len",
			args:     []Type{Array{ElemType: I64, Rank: 1}},
			expected: "Pt_3arr_p_3len_f1_Array_t1_I64",
		},
		{
			name:     "with rank-2 array type",
			modName:  "matrix",
			relPath:  "",
			funcName: "shape",
			args:     []Type{Array{ElemType: F64, Rank: 2}},
			expected: "Pt_6matrix_p_5shape_f1_Array_t1_Array_t1_F64",
		},
		{
...
func TestDemangleDisplayPreservesSymbolBoundaries(t *testing.T) {
	...
	assert.NotEqual(t, Demangle(moduleScript), Demangle(nestedModuleScript))
